...
const NAV = [
  ...
  { label: 'Centers', emoji: '🏢', path: '/admin/centers' },
  { label: 'Farmers', emoji: '👨‍🌾', path: '/admin/farmers' },
  { label: 'Officers', emoji: '👮', path: '/admin/officers' },
  { label: 'Schedules', emoji: '📅', path: '/admin/schedules' },
  { label: 'Procurement', emoji: '🌾', path: '/admin/procurement' },
  { label: 'Payments', emoji: '💰', path: '/admin/payments' },
  { label: 'Complaints', emoji: '📣', path: '/admin/complaints' },
